                ...
                <p>
                    <?php
                        if (isset($_GET['clipboard_id'])) {
                            echo htmlspecialchars($_GET['clipboard_id']);
                        }
                    ?>
                </p>
    ...
    <main>
        <section class="section-wide attachment-section">
            <div class="text-container">
                <textarea name="" id="" cols="auto" rows="" placeholder="Type or paste text here..."></textarea>
                <div class="text-actions">
                    <button class="select-all-btn" title="Select"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                    ...
                    <button class="copy-btn" title="Copy"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                            viewBox="0 -960 960 960" width="24px" fill="#ffffff">
                            <path
                    ...
                    <button class="paste-btn" title="Paste"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                            viewBox="0 -960 960 960" width="24px" fill="#ffffff">
                            <path
                    ...
                    <button class="clear-btn" title="Clear"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                            viewBox="0 -960 960 960" width="24px" fill="#ffffff">
                            <path
